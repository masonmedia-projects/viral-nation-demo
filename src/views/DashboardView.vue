  ...
  <div class="offcanvas-body">
    <ul class="list-unstyled">
        <li class="py-4 fs-5 fw-900 text-secondary border-bottom">
            <img class="me-1" style="width: 25px" src="@/assets/img/instagram.svg" alt="">  Instagram</li>
        <li class="py-4 fs-5 fw-900 text-secondary border-bottom">
            <img class="me-1" style="width: 25px" src="@/assets/img/facebook.svg" alt=""> Facebook</li>
        <li class="py-4 fs-5 fw-900 text-secondary border-bottom">
            <img class="me-1" style="width: 25px" src="@/assets/img/youtube.svg" alt=""> Youtube</li>
        <li class="py-4 fs-5 fw-900 text-secondary border-bottom">
            <img class="me-1" style="width: 25px" src="@/assets/img/tiktok.svg" alt=""> TikTok</li>
        <li class="py-4 fs-5 fw-900 text-secondary border-bottom">
            <img class="me-1" style="width: 25px" src="@/assets/img/pinterest.svg" alt=""> Pinterest</li>
        <li class="py-4 fs-5 fw-900 text-secondary border-bottom">
            <img class="me-1" style="width: 25px" src="@/assets/img/snapchat.svg" alt=""> Snapchat</li>
    </ul>
  </div>
</div>
        <nav class="nav nav-pills flex-column flex-sm-row p-3">
            <button class="nav-link active flex-sm-fill text-sm-center border border-primary mx-2" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Trending</button>
            ...
            <button class="nav-link flex-sm-fill text-sm-center border border-primary mx-2" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Search</button>
        </nav>
...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
      <div class="container-fluid">
          <div class="row w-100 p-3 border-bottom" v-for="(item, index) in users.results" :key="index">
  ...
  <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
      <div class="container-fluid px-0">
          <div class="row w-100 m-0 px-4 pt-3">
